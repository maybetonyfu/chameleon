import createNextState, { enableES5, isDraft, current, isDraftable } from '/_snowpack/pkg/immer.v9.0.12.js';
export { default as createNextState, current, freeze, isDraft, original } from '/_snowpack/pkg/immer.v9.0.12.js';
import { combineReducers, applyMiddleware, createStore, compose } from '/_snowpack/pkg/redux.v4.1.2.js';
export * from '/_snowpack/pkg/redux.v4.1.2.js';
import { createSelector } from '/_snowpack/pkg/reselect.v4.1.5.js';
export { createSelector } from '/_snowpack/pkg/reselect.v4.1.5.js';
import thunkMiddleware from '/_snowpack/pkg/redux-thunk.v2.4.1.js';
...
function getDefaultMiddleware(options) {
    ...
    var _c = options.thunk, thunk = _c === void 0 ? true : _c, _d = options.immutableCheck, _e = options.serializableCheck;
...
function createSlice(options) {
    ...
    var initialState = typeof options.initialState == "function" ? options.initialState : createNextState(options.initialState, function () {
    });
