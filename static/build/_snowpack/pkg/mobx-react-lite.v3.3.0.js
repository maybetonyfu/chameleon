import { makeObservable, configure, getDependencyTree, Reaction, observable, runInAction } from '/_snowpack/pkg/mobx.v6.4.2.js';
import React, { useState, forwardRef, memo } from '/_snowpack/pkg/react.v17.0.2.js';
...
var _a = FinalizationRegistryLocal
    ...
    : createTimerBasedReactionCleanupTracking(), addReactionToTrack = _a.addReactionToTrack, recordReactionAsCommitted = _a.recordReactionAsCommitted, resetCleanupScheduleForTests = _a.resetCleanupScheduleForTests;
...
function useAsObservableSource(current) {
    ...
    var _a = __read$1(useState(function () { return observable(current, {}, { deep: false }); }), 1), res = _a[0];
